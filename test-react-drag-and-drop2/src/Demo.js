  ...
  DropTarget = React.createClass({
    ...
    classes: function() {
      return [
        ...
        this.active() && this.props.currentDragItem.type === 'green' ? 'active-green' : void 0,
        this.active() && this.props.currentDragItem.type === 'blue' ? 'active-blue' : void 0,
    ...
    active: function() {
      var _ref1;
      return (
        this.props.currentDragItem && ((_ref1 = this.props.currentDragItem.type), __indexOf.call(this.props.target.accepts, _ref1) >= 0)
      );
    },
    disabled: function() {
      var _ref1;
    ...
    onDrop: function() {
      var _base;
      if (this.active()) {
        return typeof (_base = this.props).onDrop === 'function'
          ? _base.onDrop({
